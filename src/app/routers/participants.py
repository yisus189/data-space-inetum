...
def create_participant(
    ...
    audit.create(actor=user.preferred_username, action="create_participant", resource_type="participant", resource_id=str(p.id), details={"username": p.username})
    return p
...
def update_participant(
    ...
    audit.create(actor=user.preferred_username, action="update_participant", resource_type="participant", resource_id=str(participant_id), details=payload.dict(exclude_unset=True))
    return p
...
def delete_participant(
    ...
    audit.create(actor=user.preferred_username, action="delete_participant", resource_type="participant", resource_id=str(participant_id), details={})
    return None
